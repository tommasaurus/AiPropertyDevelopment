...
const TenantPopup = ({ tenant, onClose }) => {
  ...
  const financialData = {
    payments: [
      ...
      { id: 4, date: '2023-12-01', amount: 300, status: 'Paid', type: 'Utility' }
    ],
    expenses: [
      { id: 1, date: '2024-02-15', amount: 200, category: 'Maintenance', description: 'Plumbing repair' },
      { id: 2, date: '2024-01-20', amount: 150, category: 'Utility', description: 'Electricity bill' },
      { id: 3, date: '2024-01-10', amount: 300, category: 'Repairs', description: 'Window replacement' }
    ]
  };
    ...
    <div className="tenant-popup-overlay" onClick={onClose}>
      <div className="tenant-popup-content" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="popup-tabs">
          ...
          <button 
            className={`popup-tab ${activeTab === 'financials' ? 'active' : ''}`}
              ...
              <div className="financial-summary">
                <div className="summary-item">
                  ...
                  <span className="summary-value">
                    ${financialData.payments.reduce((sum, payment) => sum + payment.amount, 0)}
                  </span>
                </div>
                <div className="summary-item">
                  <span className="summary-label">Total Expenses</span>
                  <span className="summary-value">
                    ${financialData.expenses.reduce((sum, expense) => sum + expense.amount, 0)}
                  </span>
                </div>
              </div>
            </div>
