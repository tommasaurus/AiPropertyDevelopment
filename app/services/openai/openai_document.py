...
class OpenAIService:
    ...
    def _generate_lease_prompt(self, text: str) -> list[ChatCompletionMessage]:
        ...
        "  \"Tenant Information\": {"
        "    \"Name\": \"Name of tenant(s)\","
        "    \"Address\": \"Tenant address\","
        "    \"Landlord\": \"Name of landlord\","
        "    \"Management/Agent\": \"Name of property management or agent\""
        "  },"
    ...
    def _generate_invoice_prompt(self, text: str) -> list[ChatCompletionMessage]:
        """
        Generates a prompt for extracting key invoice information.
        """
        system_prompt = "You are an assistant that extracts invoice details in JSON format."
        user_prompt = (
